...
const UserLogin: React.FC = () => {
  ...
  const { userInfo, loginError, loginLoading } = useSelector((state: RootState) => state.user);
      ...
      <div className="grid grid-cols-2 h-screen">
        ...
        <div className="flex justify-center items-center h-screen bg-gradient-to-r from-blue-50 to-blue-500">
          <form className="w-2/3" onSubmit={handleLogin}>
            ...
            {serverError && <p className="text-red-600 text-sm font-semibold text-center mb-4">{serverError}</p>}
            ...
            <p
              ...
              className="flex justify-center mb-6 transition duration-150 ease-in-out text-gray-800 hover:text-blue-950 hover:font-semibold hover:cursor-pointer"
            >
            ...
            <p className="flex justify-center mt-6 font-bold">or</p>
            <div className="flex justify-center mt-4">
              <button
                type="button"
                onClick={handleGoogleLogin}
                className="flex items-center border border-gray-300 rounded-full px-4 py-2 bg-white shadow-md hover:scale-105 transition duration-300 ease-in-out"
              >
                <img
